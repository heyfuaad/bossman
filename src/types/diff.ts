...
export interface Comment {
  ...
  severity?: 'critical' | 'important' | 'suggestion' | 'observation'; // AI review severity
  isAIGenerated?: boolean; // Whether this comment was generated by an AI model
}
...
export interface DiffComment {
  ...
  // AI review severity (only set for AI-generated comments)
